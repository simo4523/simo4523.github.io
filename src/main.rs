...
fn main() {
    ...
    const PAGES: [Page; 3] = [
        Page { folder_name: "crypto", target_file_name: "crypto" },
        Page { folder_name: "fl-studio", target_file_name: "fl-studio" },
        Page { folder_name: "home", target_file_name: "index" },
    ];
            ...
            Ok(mut f) => {
                ...
                if let Err(e) = f.read_to_string(&mut contents) {
                    ...
                    if let Err(e) = std::fs::write(
                        &new_filename,
                        base_contents.as_str().replace("%content%", &contents),
                    ) {
